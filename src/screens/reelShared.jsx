    ...
    <div style={{ position: 'absolute', inset: 0, background: 'rgba(38,58,44,0.97)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '0 36px' }}>
      ...
      {slide.subtype === 'letter' ? (
        ...
        <>
          ...
          <p style={{ margin: '0 0 18px', fontFamily: "'Source Serif 4', serif", fontStyle: 'italic', fontSize: 21, lineHeight: 1.55, color: '#fff', textAlign: 'center' }}>
            {slide.text}
          </p>
          {kidFirst && (
    ...
    <div style={{ position: 'absolute', inset: 0, background: '#1E2A1E', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', zIndex: 50, padding: '0 32px' }}>
      ...
      {[
        ...
        <button
          ...
          style={{ position: 'absolute', top: 16, right: 16 + i * 36, background: 'rgba(255,255,255,0.1)', border: 'none', borderRadius: '50%', width: 28, height: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: btn.disabled ? 'default' : 'pointer', opacity: btn.disabled ? 0.6 : 1, color: btn.color || '#fff', fontSize: 14 }}
        >
          <Icon name={btn.icon} />
        </button>
      ))}
